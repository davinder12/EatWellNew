...
import com.android.eatwell.view.dashboard.fragment.HomeFragment.Companion.RESTURANT_CLOSE
import com.android.eatwell.view.dashboard.fragment.HomeFragment.Companion.RESTURANT_OPEN
    ...
    var foodResource = PagedListViewModel(search) {
        productRepository.searchApi(
                FoodRequestModel(
                       ...
                       ,getCurrentListSize(),
                        preferenceService.getString(R.string.pkey_userLong,"0.0"), OFFSET,
