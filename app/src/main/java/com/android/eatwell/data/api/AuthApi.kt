...
import com.android.eatwell.data.models.ProfileResponse
import com.android.eatwell.data.models.TermConditionResponse
...
interface AuthApi {
    ...
    fun userDelete(@Field("user_id") userId: String?): Single<Response<Unit>>
